...
describe('BS in CyberSecurity Program Node', () => {
  ...
  test('should have a specific page title and specific program name', () => {
    ...
    expect(title.textContent).toBe('BS in CyberSecurity')

    // Check program name
    expect(program).toBeTruthy()
    expect(program.getName()).toMatch(/^BS In CyberSec\s+\d\d\d\d$/)
  })
