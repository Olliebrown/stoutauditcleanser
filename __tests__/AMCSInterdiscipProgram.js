...
const baseHTML = fs.readFileSync(path.join('__tests__', 'data', 'AMCSInterdiscipProgram.html'), 'utf8')
...
describe('General Info Node', () => {
  ...
  test('should have a specific page title and specific program prefix', () => {
    ...
    expect(title.textContent).toBe('BS Applied Math Computer Science Interdisciplinary')
