...
const baseHTML = fs.readFileSync(path.join('__tests__', 'data', 'MinorMathematics.html'), 'utf8')
...
describe('General Info Node', () => {
  ...
  test('should have a specific page title and specific program name', () => {
    ...
    expect(title.textContent).toBe('Minor Mathematics')

    // Check program name
    expect(program).toBeTruthy()
    expect(program.getName()).toBe('Minor: mathematics')
  })
})
