...
describe('Computer Network Systems and Design Minor Node', () => {
  // Inject clean version of HTML page and rebuild program before tests
  let program = null
  beforeAll(() => {
    // Load page from imported HTML
    program = InitProgramTest('MinorCNSandD.html')
  })
  ...
  test('should have a specific page title and specific program name', () => {
    ...
    expect(title.textContent).toBe('Minor Computer Networking Systems & Design')
